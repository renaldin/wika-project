                ...
                <table id="user-list-table" class="table table-striped" role="grid" data-toggle="data-table">
                    ...
                    <tbody>
                        ...
                        @foreach ($daftar as $item)
                                ...
                                @if($item->checked == 1 && $item->validasi == 0)
                                    <tr>
                                        <td>{{$no++}}</td>
                                        <td>
                                        ...
                                        <div class="flex align-items-center list-user-action">
                                            <button type="button" class="btn btn-sm btn-icon btn-success" data-toggle="tooltip" data-bs-toggle="modal" data-bs-target="#check{{$item->id_engineering_activity}}" data-placement="top" title="Validasi" data-original-title="Validasi">
...
<div class="modal fade" id="check{{$item->id_engineering_activity}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Apakah Anda Yakin Akan Validasi?</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Keluar</button>
                <a href="/validasi-activity/{{$item->id_engineering_activity}}" type="button" class="btn btn-primary">Validasi</a>
            </div>
        </div>
    </div>
</div>
