                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex align-items-center list-user-action">
                                        <a href="/detail-proyek-lps-tim/{{$item->id_proyek}}" class="btn btn-sm btn-icon btn-primary" data-toggle="tooltip" data-placement="top" title="Detail" data-original-title="Detail">
                ...
                @csrf
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" class="form-control" value="{{$item->dokumen_lps}}" name="dokumen_lps" placeholder="Masukkan Link Dokumen" required>
                        </div>
                    </div>
            </div>
