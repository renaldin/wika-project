    ...
    <div class="col-md-4">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <h4>Daftar Agenda</h4>
                    <div style="max-height: 250px; overflow-y: auto;"> <!-- Membatasi tinggi tabel -->
                        <table class="table table-sm table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ \Carbon\Carbon::parse($agenda->tanggal_kegiatan)->format('d M Y') }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="agendaModalLabel">Peringatan Agenda</h5>
