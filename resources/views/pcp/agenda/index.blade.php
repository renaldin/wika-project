            ...
            <div class="card-body px-4" style="margin-bottom: -50px;">
                <div class="row">
                    <div class="col-lg-8 mb-1">
                        <a href="/tambah-agenda" class="btn btn-primary mb-4">Tambah</a>
                    </div>
                    @if (session('success'))
                        <div class="col-lg-12">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex align-items-center list-user-action">
                                        <a href="/pic-agenda/{{$item->id}}" class="btn btn-sm btn-icon btn-primary" data-toggle="tooltip"  data-placement="top" title="Edit PIC" data-original-title="Edit PIC">
                                        ...
                                        <a href="/detail-agenda/{{$item->id}}" class="btn btn-sm btn-icon btn-primary" data-toggle="tooltip"  data-placement="top" title="Detail" data-original-title="Detail">
                                            <span class="btn-inner">
                                        ...
                                        <a href="/edit-agenda/{{$item->id}}" class="btn btn-sm btn-icon btn-success" data-toggle="tooltip" data-placement="top" title="Edit" data-original-title="Edit">
                                            <span class="btn-inner">
                                        ...
                                        <button type="button" class="btn btn-sm btn-icon btn-danger btn-delete" data-toggle="tooltip" data-placement="top" title="Hapus" data-original-title="Hapus" data-href="/hapus-agenda/{{$item->id}}" data-content="Apakah Anda yakin akan hapus data ini ?">
                                            <span class="btn-inner">
