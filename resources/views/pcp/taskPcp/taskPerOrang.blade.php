                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($item->status_tugas == 'Open')
                                        <span class="badge badge-primary">{{ $item->status_tugas }}</span>
                                    ...
                                    @elseif($item->status_tugas == 'Close')
                                        <span class="badge badge-secondary">{{ $item->status_tugas }}</span>
                                    @endif    
                                </td>
                                <td>
                                    <div class="flex align-items-center list-user-action">
                                        <a href="/detail-task-pcp-per-orang/{{$item->id}}" class="btn btn-sm btn-icon btn-primary" data-toggle="tooltip"  data-placement="top" title="Detail" data-original-title="Detail">
                                        ...
                                        @if ($item->status_tugas == 'Open' || $item->status_tugas == 'Revisi')
                                            <a href="/edit-task-pcp-per-orang/{{$item->id}}" class="btn btn-sm btn-icon btn-success" data-toggle="tooltip" data-placement="top" title="Edit" data-original-title="Edit">
                                                <span class="btn-inner">
