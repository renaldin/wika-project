        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="new-user-info">
                    <form action="@if($form == 'Tambah')/tambah-task-pcp-proyek @else/edit-task-pcp-proyek/{{$detail->id}}@endif" method="POST" enctype="multipart/form-data" id="taskPcpForm">
                        <div class="row">
                            @csrf
                            @if ($form == 'Detail')
                        ...
                        @include('components.tombolForm', ['linkKembali' => '/daftar-task-pcp-proyek'])
                    </form>
                </div>
            </div>
        </div>
