                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex align-items-center list-user-action">
                                        <a href="/detail-task-pcp-proyek/{{$item->id}}" class="btn btn-sm btn-icon btn-primary" data-toggle="tooltip"  data-placement="top" title="Detail" data-original-title="Detail">
                                        ...
                                        @if ($item->status_tugas == 'Open' || $item->status_tugas == 'Revisi')
                                            <a href="/edit-task-pcp-proyek/{{$item->id}}" class="btn btn-sm btn-icon btn-success" data-toggle="tooltip" data-placement="top" title="Edit" data-original-title="Edit">
                                                <span class="btn-inner">
