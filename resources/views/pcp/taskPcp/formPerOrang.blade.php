        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="new-user-info">
                    <form action="@if($form == 'Tambah')/tambah-task-pcp-per-orang @else/edit-task-pcp-per-orang/{{$detail->id}}@endif" method="POST" enctype="multipart/form-data" id="taskPcpForm">
                        <div class="row">
                            @csrf
                            @if ($form == 'Detail')
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="status_tugas" id="status_tugas" class="form-control @error('status_tugas') is-invalid @enderror" @if($form == 'Detail' || Session()->get('role') == 'Manajemen') disabled @endif required>
                                    ...
                                    @if ($user->role == 'Head Office' || $form == 'Detail')
                        ...
                        @include('components.tombolForm', ['linkKembali' => '/daftar-task-pcp-per-orang'])
                    </form>
                </div>
            </div>
        </div>
