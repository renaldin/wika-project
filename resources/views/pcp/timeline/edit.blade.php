...
<div class="row">
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <div class="header-title">
                <h4 class="card-title">Detail Timeline</h4>
                </div>
            </div>
                    ...
                    <tbody>
                        ...
                        @foreach ($timelineDetail as $item)
                            <tr>
                                ...
                                <td>
                                    {{$item->timeline_sub_detail_count}}
                                </td>
                                <td>
                                    @if($item->status == 0)
                                ...
                                <td>
                                    <div class="flex align-items-center list-user-action">
                                        @if ($user->role == 'Head Office')
                                            @if($item->status == 0)
                                                <button type="button" href="/verifikasi-detailtimeline/{{$item->id}}" class="btn btn-sm btn-icon btn-success btn-verifikasi" data-toggle="tooltip"  data-placement="top" title="Verifikasi" data-original-title="Verifikasi" data-href="/verifikasi-detailtimeline/{{$item->id}}" data-content="Apakah Anda yakin akan verifikasi data ini?">
                                            ...
                                            @else
                                                <button type="button" href="/bukaverifikasi-detailtimeline/{{$item->id}}" class="btn btn-sm btn-icon btn-danger btn-verifikasi" data-toggle="tooltip"  data-placement="top" title="Buka Verifikasi" data-original-title="Buka Verifikasi" data-href="/bukaverifikasi-detailtimeline/{{$item->id}}" data-content="Apakah Anda yakin akan buka verifikasi data ini?">
                                                    <span class="btn-inner">
                                        ...
                                        @else
                                            <a href="/sub-detail-timeline/{{$item->id}}" class="btn btn-sm btn-icon btn-primary" data-toggle="tooltip"  data-placement="top" title="Detail" data-original-title="Detail">
                                                <span class="btn-inner">
