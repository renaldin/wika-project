        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="new-user-info">
                    <form action="@if($form == 'Tambah')/tambah-dokumen-timeline @else/edit-dokumen-timeline/{{$detail->id}}@endif" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            @csrf
                        ...
                        @include('components.tombolForm', ['linkKembali' => '/daftar-dokumen-timeline'])
                    </form>
                </div>
            </div>
        </div>
