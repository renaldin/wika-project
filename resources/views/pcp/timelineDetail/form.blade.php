                    ...
                    <tbody>
                        ...
                        @foreach ($timelineDetail as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="/download-file-dokumen-timeline/{{$item->id}}" class="btn btn-sm btn-primary">
                                ...
                                {{-- <td>
                                    <div class="flex align-items-center list-user-action">
                                        <a class="btn btn-sm btn-icon btn-success" data-toggle="tooltip" data-placement="top" title="Edit" data-original-title="Edit" href="/edit-detail-timeline/{{$item->id}}">
