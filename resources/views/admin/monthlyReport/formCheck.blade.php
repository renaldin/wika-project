...
@section('content')
<form action="@if($form == 'Tambah') /tambah-check-monthly-report @elseif($form == 'Edit') /edit-check-monthly-report/{{$detail->id_monthly_report}} @endif" method="POST">
    @csrf
    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="form-check d-block">
                                    <input class="form-check-input" type="checkbox" name="dua_d_temp" id="dua_d_temp" @if($detail->dua_d_temp == 1) checked @endif>
                                    <label class="form-check-label" for="dua_d_temp">
                                        2D
                                    </label>
                                </div>
                                <div class="form-check d-block">
                                    <input class="form-check-input" type="checkbox" name="tiga_d_temp" id="tiga_d_temp" @if($detail->tiga_d_temp == 1) checked @endif>
                                    <label class="form-check-label" for="tiga_d_temp">
                                        3D
                                    </label>
                                </div>
                                <div class="form-check d-block">
                                    <input class="form-check-input" type="checkbox" name="empat_d_temp" id="empat_d_temp" @if($detail->empat_d_temp == 1) checked @endif>
                                    <label class="form-check-label" for="empat_d_temp">
                                        4D
                                    </label>
                                </div>
                                <div class="form-check d-block">
                                    <input class="form-check-input" type="checkbox" name="lima_d_temp" id="lima_d_temp" @if($detail->lima_d_temp == 1) checked @endif>
                                    <label class="form-check-label" for="lima_d_temp">
                                        5D
                                    </label>
                                </div>
                                <div class="form-check d-block">
                                    <input class="form-check-input" type="checkbox" name="cde_d_temp" id="cde_d_temp" @if($detail->cde_d_temp == 1) checked @endif>
                                    <label class="form-check-label" for="cde_d_temp">
                                        CDE
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="new-user-info">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control @error('realisasi_proyek') is-invalid @enderror" id="realisasi_proyek" name="realisasi_proyek" value="@if($form == 'Tambah'){{ old('realisasi_proyek') }}@elseif($form == 'Edit'){{$detail->realisasi_proyek}}@endif" @if($form == 'Detail') disabled @endif autofocus placeholder="Masukkan Realisasi Proyek" required>
                        ...
                        @include('components.tombolForm', ['linkKembali' => '/check-monthly-report'])
                    </div>
                </div>
            </div>
        </div>
