                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex align-items-center list-user-action">
                                    <a class="btn btn-sm btn-icon btn-success" data-toggle="tooltip" data-placement="top" title="Edit" data-original-title="Edit" href="/edit-software/{{$item->id_software}}">
                                    ...
                                    <button type="button" class="btn btn-sm btn-icon btn-danger" data-toggle="tooltip" data-bs-toggle="modal" data-bs-target="#hapus{{$item->id_software}}" data-placement="top" title="Hapus" data-original-title="Hapus">
                                        <span class="btn-inner">
