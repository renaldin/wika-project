        ...
        <div class="card">
            ...
            <div class="card-body px-4" style="margin-bottom: -50px;">
                <div class="row">
                    @if ($user->role == 'Admin')
                        <div class="col-lg-12">
                            <a href="/export-proyek" class="btn btn-primary mb-4">Export Excel</a>
                            <a href="/export-proyek-pdf" class="btn btn-primary mb-4">Export PDF</a>
                        </div>
                    @endif
                    @if (session('success'))
                        <div class="col-lg-12">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex align-items-center list-user-action">
                                    <a href="/daftar-proyek-user/{{$item->id_proyek}}" class="btn btn-sm btn-icon btn-primary" data-toggle="tooltip" data-placement="top" title="Tim Proyek" data-original-title="Tim Proyek">
