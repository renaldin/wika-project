                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><div class="flex align-items-center list-user-action">
                                <a href="{{ asset('sni/' . $item->file) }}" class="btn btn-sm btn-icon btn-info" target="_blank" data-toggle="tooltip" title="Lihat PDF" data-original-title="Lihat PDF">
                                ...
                                <td>
                                    <div class="flex align-items-center list-user-action">
                                        <a class="btn btn-sm btn-icon btn-success" data-toggle="tooltip" data-placement="top" title="Edit" data-original-title="Edit" href="/edit-sni/{{$item->id_sni}}">
                                            <span class="btn-inner">
                                        ...
                                        <button type="button" class="btn btn-sm btn-icon btn-danger" data-toggle="tooltip" data-bs-toggle="modal" data-bs-target="#hapus{{$item->id_sni}}" data-placement="top" title="Hapus" data-original-title="Hapus">
                                            <span class="btn-inner">
