        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="new-user-info">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <a href="/detail-laporan-qa/{{$detail->id_laporan_qa}}" class="btn btn-secondary">Kembali</a>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="row">
                ...
                <div class="row">
                    @if ($user->role == 'Tim Proyek')
                        <div class="col-lg-8 mb-1">
                            <a href="/tambah-laporan-qa-sub-detail/{{$detail->id}}" class="btn btn-primary mb-4">Tambah</a>
                        </div>
                    @endif
                    @if (session('success'))
                        <div class="col-lg-12">
                ...
                <table id="user-list-table" class="table table-striped" role="grid" data-toggle="data-table">
                    ...
                    <tbody>
                        ...
                        @foreach ($daftar as $item)
                            <tr>
                                <td>{{$no++}}</td>
                                <td>{{$item->nama_dokumen_qa}}</td>
                                <td>{{$item->tanggal_dokumen_qa}}</td>
                                <td>
                                    <a href="/download-file-sub-dokumen-laporan-qa/{{$item->id}}" class="btn btn-sm btn-primary">
                                    ...
                                    @if ($user->role == 'Tim Proyek')
                                        <td>
                                            <div class="flex align-items-center list-user-action">
                                                <a href="/edit-laporan-qa-sub-detail/{{$detail->id}}/{{$item->id}}" class="btn btn-sm btn-icon btn-success" data-toggle="tooltip" data-placement="top" title="Edit" data-original-title="Edit">
    ...
    data-href="/hapus-laporan-qa-sub-detail/{{$item->id}}" 
