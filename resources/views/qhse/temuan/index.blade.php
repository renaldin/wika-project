            ...
            <div class="card-body px-4" style="margin-bottom: -50px;">
                <div class="row">
                    ...
                    <div class="col-lg-4 mb-3">
                        <form action="{{ route('daftar-laporan-qa') }}" method="GET">
                    ...
                    @if ($user->role == 'Head Office')
                        <div class="col-lg-8 mb-1">
                            <a href="/tambah-temuan" class="btn btn-primary mb-4">Tambah</a>
                        </div>
                    @endif
                    @if (session('success'))
                        <div class="col-lg-12">
                ...
                <table id="user-list-table" class="table table-striped" role="grid" data-toggle="data-table">
                    ...
                    <tbody>
                        ...
                        @foreach ($daftarTemuan as $temuan)
                            <tr>
                                <td>{{$no++}}</td>
                                <td>{{ $temuan->agenda ? $temuan->agenda->nama_kegiatan : 'Tidak ada Agenda' }}</td>
                                <td>
                                ...
                                <td>{{ date('d-m-Y', strtotime($temuan->duedate)) }}</td>
                                <td>
                                    <div class="flex align-items-center list-user-action">
 
                                        <a href="/edit-temuan/{{$temuan->id}}" class="btn btn-sm btn-icon btn-primary" data-toggle="tooltip"  data-placement="top" title="Detail" data-original-title="Detail">
                                        ...
                                        <button type="button" class="btn btn-sm btn-icon btn-danger" data-toggle="tooltip" data-placement="top" title="Hapus" data-href="/hapus-temuan/{{$temuan->id}}" onclick="confirmDelete(this)">
                                            <span class="btn-inner">
...
<script>
    function confirmDelete(button) {
        ...
        if (confirm('Apakah Anda yakin ingin menghapus data ini?')) {
            // Jika ya, lakukan redirect ke URL hapus
