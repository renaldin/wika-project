                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex align-items-center list-user-action">
                                        <a href="/detail-log/{{$item->id_log}}" class="btn btn-sm btn-icon btn-primary" data-toggle="tooltip"  data-placement="top" title="Detail" data-original-title="Detail">
                                        ...
                                        <button type="button" class="btn btn-sm btn-icon btn-danger btn-delete" data-toggle="tooltip" data-placement="top" title="Hapus" data-original-title="Hapus" data-href="/hapus-log/{{$item->id_log}}" data-content="Apakah Anda yakin akan hapus data ini ?">
                                            <span class="btn-inner">
