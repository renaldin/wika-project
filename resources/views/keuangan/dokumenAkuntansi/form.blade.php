        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="new-user-info">
                    <form action="@if($form == 'Tambah')/tambah-dokumen-akuntansi @else/edit-dokumen-akuntansi/{{$detail->id}}@endif" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            @csrf
                        ...
                        @include('components.tombolForm', ['linkKembali' => '/daftar-dokumen-akuntansi'])
                    </form>
                </div>
            </div>
        </div>
