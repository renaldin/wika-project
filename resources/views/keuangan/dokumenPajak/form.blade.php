        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="new-user-info">
                    <form action="@if($form == 'Tambah')/tambah-dokumen-pajak @else/edit-dokumen-pajak/{{$detail->id}}@endif" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            @csrf
                        ...
                        @include('components.tombolForm', ['linkKembali' => '/daftar-dokumen-pajak'])
                    </form>
                </div>
            </div>
        </div>
