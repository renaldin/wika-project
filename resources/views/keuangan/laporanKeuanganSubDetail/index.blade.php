        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="new-user-info">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <a href="/edit-laporan-keuangan/{{$detail->id_laporan_keuangan}}" class="btn btn-secondary">Kembali</a>
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <td>
                                            <div class="flex align-items-center list-user-action">
                                                ...
                                                @if (!$item->id_verifikator)
                                                    <button type="button" class="btn btn-sm btn-icon btn-danger btn-delete" data-toggle="tooltip" data-placement="top" title="Hapus" data-original-title="Hapus" data-href="/hapus-laporan-keuangan-sub-detail/{{$item->id}}" data-content="Apakah Anda yakin akan hapus data ini?">
                                                        <span class="btn-inner">
