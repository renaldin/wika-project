                    ...
                    <tbody>
                        ...
                        @foreach ($laporanProyekDetail as $item)
                            <tr>
                                ...
                                <td>
                                    {{$item->laporan_proyek_sub_detail_count}}
                                </td>
                                <td>
                                    @if($item->status == 0)
                                ...
                                <td>
                                    <div class="flex align-items-center list-user-action">
                                        ...
                                        @else
                                            <a href="/sub-detail-laporan-proyek/{{$item->id}}" class="btn btn-sm btn-icon btn-primary" data-toggle="tooltip"  data-placement="top" title="Detail" data-original-title="Detail">
                                                <span class="btn-inner">
