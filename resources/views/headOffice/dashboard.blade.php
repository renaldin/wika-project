               ...
               <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="900">
                  <div class="card-body">
                     <div class="progress-widget">
                        <div id="circle-progress-01" class="text-center circle-progress-01 circle-progress circle-progress" style="colour: #3AEDB5" data-min-value="0" data-max-value="100" data-value="100" data-type="percent">
                        ...
                        <div class="progress-detail">
                           ...
                           <h4 class="counter">{{ number_format(round($akumulasiCsi, 2), 2) }}</h4>
                  ...
                  <div class="card" data-aos="fade-up" data-aos-delay="800">
                     <div class="card-body">
                        <form action="/dashboard" method="POST" class="d-flex align-items-center">
                           @csrf
                           <select name="tahun" id="tahun" class="selectpicker form-control">
