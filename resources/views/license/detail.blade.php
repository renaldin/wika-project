                ...
                <form action="/edit-detail-license/{{$item->id_detail_license}}" method="POST">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <select name="status" id="status" class="selectpicker form-control @error('status') is-invalid @enderror" required>
                ...
                <form action="/tambah-detail-license" method="POST">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <select name="id_software" id="id_software" class="selectpicker form-control @error('id_software') is-invalid @enderror" required>
                                <option value="" selected disabled>-- Pilih --</option>
