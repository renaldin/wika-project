                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex align-items-center list-user-action">
                                            ...
                                            <button type="button" class="btn btn-sm btn-icon btn-danger btn-delete" data-toggle="tooltip" data-href="/hapus-license/{{$item->id_license}}" data-content="Apakah Anda yakin akan hapus data ini?" data-placement="top" title="Hapus" data-original-title="Hapus">
                                                <span class="btn-inner">
