                ...
                <table id="user-list-table" class="table table-striped" role="grid" data-toggle="data-table">
                    ...
                    <tbody>
                        ...
                        @foreach ($daftarTask as $item)
                            <tr>
                                <td>{{$no++}}</td>
                                @if (Session()->get('role') == 'Manajemen' || Session()->get('jabatan') == 'Coordinator')
                                    <td>{{$item->personil->nama_user}}</td>
                                @endif
                                <td style="white-space: normal; word-wrap: break-word; overflow-wrap: break-word; max-width: 200px;">{{$item->item_task}}</td>
                                <td>{{$item->timeline}}</td>
                                <td>
                                ...
                                <td>
                                    @if ($item->link)
                                        <a href="{{ $item->link }}" class="btn btn-primary" target="_blank">Lihat Dokumen</a>
                                    @endif
                                </td>
