                                ...
                                <td>
                                    <div class="flex align-items-center list-user-action">
                                        {{-- @if ($user->role == 'Head Office')
                                            <button type="button" href="/verifikasi-timeline/{{$item->id}}" class="btn btn-sm btn-icon btn-success btn-verifikasi" data-toggle="tooltip"  data-placement="top" title="Verifikasi" data-original-title="Verifikasi" data-href="/verifikasi-timeline/{{$item->id}}" data-content="Apakah Anda yakin akan verifikasi data ini?">
